...
>
    ...
    >
        <div
            class="relative aspect-[4/3] overflow-hidden bg-gradient-to-br from-violet-100 via-fuchsia-50 to-amber-50"
        >
            ...
            @else
                ...
                >
                    <div
                        class="flex h-16 w-16 items-center justify-center rounded-2xl bg-white/80 text-violet-700 shadow-sm"
                    >
                        <svg
                    ...
                    <p
                        class="mt-3 text-sm font-semibold text-violet-800"
                    >
                        Produk Sasirangan
                    </p>
                </div>
            ...
            @elseif ($product->stock <= 5)
                <span
                    class="absolute left-4 top-4 rounded-full bg-amber-500 px-3 py-1 text-xs font-semibold text-white"
                >
                    Stok terbatas
                </span>
            @endif
    ...
    <div class="p-5">
        <p
            class="text-xs font-semibold uppercase tracking-wider text-violet-600"
        >
        ...
        <a href="{{ route('store.product.show', $product) }}">
            <h3
                class="mt-2 min-h-12 text-base font-bold leading-6 text-slate-900 transition group-hover:text-violet-700"
            >
        ...
        {{-- Nama UMKM dapat diklik --}}
        <a
            href="{{ route(
                'store.umkm.show',
                $product->umkm
            ) }}"
            class="mt-2 inline-flex text-sm font-medium text-slate-500 transition hover:text-violet-700 hover:underline"
        >
